...
int SegmentImage(const Mat &_src3f, Mat &pImgInd, double sigma = 0.5, double c = 1, int min_size = 50);
int SegmentImageI(const Mat &_src3f, Mat &pImgInd, double sigma = 0.5, double c = 1, int min_size = 50);
