...
float SalientRegionDetector::compute_downsample_ratio(Size oldSz, float downSampleFactor, Size& newSz)
{
...
bool SalientRegionDetector::down_sample_image(Bitmap& inputImg, float down_ratio, Bitmap& newImg)
{
	// set params
