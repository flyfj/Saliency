...
{
    SAFE_ARRAYDELETE(m_pbyGridRgbPixels);
    SAFE_ARRAYDELETE(m_pfGridLabPixels);
    SAFE_ARRAYDELETE(m_piGridRgbSum);

    SAFE_ARRAYDELETE(m_pfBGScores);
    SAFE_ARRAYDELETE(m_piPreviousIds);
    SAFE_ARRAYDELETE(m_piNeighborPatchIds);
    SAFE_ARRAYDELETE(m_pfNeighborPatchDists);

    SAFE_ARRAYDELETE(m_piBoundaryIds);
    SAFE_ARRAYDELETE(m_pfBoundaryBgScores);
