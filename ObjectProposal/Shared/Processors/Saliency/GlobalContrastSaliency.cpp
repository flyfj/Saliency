...
namespace visualsearch
{
	namespace processors
	{
		namespace attention
		{
			GlobalContrastSaliency::GlobalContrastSaliency(void)
			{
			}

			//////////////////////////////////////////////////////////////////////////

			void GlobalContrastSaliency::GetHC(const Mat &binColor3f, const Mat &weight1f, Mat &_colorSal)
			{
			...
			Mat GlobalContrastSaliency::GetHC(const Mat &img3f)
			{
				// Quantize colors and
			...
			void GlobalContrastSaliency::SmoothSaliency(const Mat &binColor3f, Mat &sal1d, float delta, const vector<vector<CostfIdx>> &similar)
			{
				if (sal1d.cols < 2)
					return;
